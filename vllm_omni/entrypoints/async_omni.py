        ...
        default_stage_cfg = [
            {
                ...
                "engine_args": {
                    ...
                    "quantization_config_file": kwargs.get("quantization_config_file", None),
                    "quantization_config_dict_json": kwargs.get("quantization_config_dict_json", None),
                    "quantization_scope": kwargs.get("quantization_scope", "transformer_only"),
                    "quantized_weights": kwargs.get("quantized_weights", None),
                },
                "final_output": True,
