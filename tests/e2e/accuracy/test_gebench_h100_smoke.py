...
def test_gebench_h100_smoke(
    ...
    assert summary["evaluation"]["overall_mean"] >= 0.47
    assert summary["evaluation"]["by_type"]["type3"]["overall_mean"] >= 0.47
    assert summary["evaluation"]["by_type"]["type4"]["overall_mean"] >= 0.47
