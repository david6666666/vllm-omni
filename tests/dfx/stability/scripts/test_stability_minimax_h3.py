...
"""MiniMax-H3 DLO + USP4 long-running stability test."""
...
DEFAULT_NUM_PROMPTS_PER_BATCH = 3
...
def test_stability_minimax_h3(omni_server, stability_benchmark_params):
    ...
    bench_params = {
        ...
        if key not in ("duration_sec", "request_rate", "max_concurrency", "num_prompts_per_batch")
    }
